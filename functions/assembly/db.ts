...
export function addGame(letter: string, categories: string): string {
  ...
  const result = connection.invokeGraphqlApi<MutationResult>(
    DGRAPH_HOST,
    statement,
    vars,
  );
...
export function addResponse(
  ...
  const result = connection.invokeGraphqlApi<MutationResultNumUids>(
    DGRAPH_HOST,
    statement,
    vars,
  );
...
export function getGameInfo(game: string): GameInfo {
  ...
  const result = connection.invokeGraphqlApi<GetGame>(
    DGRAPH_HOST,
    statement,
    vars,
  );
